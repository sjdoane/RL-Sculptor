...
- **Verified (final):** sculptor **921 passed / 1 skip**, UI backend **362 passed**; the AST escape vectors + posture-confound + honest-grant matrices are regression-locked. KG functioning (stats 94/493/1555/519, graph.html 200, semantic search relevant).
